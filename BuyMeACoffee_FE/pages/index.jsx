  ...
  const buyCoffee = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const coffeeTxn = await buyMeACoffee.buyCofee(
          name ? name : "anon",
...
const buyLargeCoffee = async () => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy Sanjeeth a Coffee!</title>
          ...
          <div>
            <form>
              ...
              <div>
                ...
                >
                  Send 1 large Coffee for 0.03ETH
                </button>
              </div>
            </form>
          </div>
      ...
      <footer className={styles.footer}>
        <a
          href="https://twitter.com/sandev111981"
          target="_blank"
          rel="noopener noreferrer"
        >
          Created by @sandev111981 Road to Web3 week two!
        </a>
      </footer>
    </div>
  )
